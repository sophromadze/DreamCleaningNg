...
export class ManhattanCleaningComponent implements OnInit, OnDestroy {
  ...
  private injectSchema(): void {
    const schema = {
      ...
      'description': `Dream Cleaning provides professional cleaning services across 24 ZIP codes in Manhattan, New York â€” including Midtown, Chelsea, Lower East Side, Upper West Side, Financial District, and SoHo. Standard cleaning from $${SERVICE_PRICING.residentialFrom}, deep cleaning from $${SERVICE_PRICING.deepFrom}.`,
